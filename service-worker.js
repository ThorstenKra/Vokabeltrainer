...
const PRECACHE = [
  ...
  "./src/data/academic_word_list_27.json",
  "./src/data/academic_word_list_28.json",
  "./src/data/academic_word_list_29.json",
  "./src/data/academic_word_list_30.json",
  "./src/data/academic_word_list_31.json",
  "./src/data/academic_word_list_32.json",
  "./src/data/academic_word_list_33.json",
  "./src/data/academic_word_list_34.json",
  "./src/data/academic_word_list_35.json",
  "./src/data/academic_word_list_36.json",
  "./src/data/academic_word_list_37.json"
];
